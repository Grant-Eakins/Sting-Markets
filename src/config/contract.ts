...
// Contract addresses
// Import shared contract addresses
export { CONTRACT_ADDRESSES, DUAL_COIN_CONTRACT_ADDRESSES, LISTING_AUCTION_ADDRESSES, TOKEN_ADDRESSES, MIND_TOKEN_ADDRESSES } from '../../shared/contracts';
