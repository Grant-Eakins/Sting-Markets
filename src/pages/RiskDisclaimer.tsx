      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Alert variant="destructive" className="mb-8">
          ...
          <AlertDescription className="text-base mt-2">
            <strong>Coin Battles and prediction markets involve substantial risk of loss.</strong> You should only participate with 
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="prose prose-sm dark:prose-invert">
              <p>If you choose to participate in Coin Battles, please follow these guidelines:</p>
              <ul>
                ...
                <li>✅ Understand the coins you're betting on</li>
